...
contract MarketLiquidateForkTest is MarketForkTest {
    ...
    ///      emits, flag included. The payout is measured, not computed (see the event), so the
    ...
    function _expectLiquidate(
        ...
        emit FarmentaMarket.Liquidate(tokenId, liquidator, repaid, out0, out1, badDebt, fullSeizure);
    }
